...
{
    internal MuscleGain3TrainingAfter4Meals(decimal targetGramsProteinPerDay) : base(
        "Muscle Gain 3",
        nonworkoutMeals:
        [
            new Meal("Waking",
        ...
        [
            new Meal("1-3 hours before workout",
                new(P: MuscleGainProteinPerMealOnWorkoutDay(targetGramsProteinPerDay), F: 20, C: 60),
            ...
            new("1/2 shake during workout, 1/2 right after",
                new(P: MuscleGainProteinPerMealOnWorkoutDay(targetGramsProteinPerDay), F: 0, C: 80),
