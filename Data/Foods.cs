...
internal static class Foods
{
    ...
    public static Food BlueBerries_1_Cup { get; } = new("frozen blueberries", new(
        [(140, ServingUnits.Gram), (1, ServingUnits.Cup)], Cals: 70, P: 0, F: 1, CTotal: 17, CFiber: 4));

    public static Food BrownRice_45_Grams { get; } = new("brown rice", new(
        [(0.25, ServingUnits.Cup), (45, ServingUnits.Gram)], Cals: 170, P: 4, F: 1.5, CTotal: 35, CFiber: 2),
    ...
    public static Food NutritionalYeast_Sprouts { get; } = new("nutritional yeast from Sprouts", new(
        [(2, ServingUnits.Tablespoon), (16, ServingUnits.Gram)],
        Cals: 60,
    ...
    public static Food PumpkinSeeds { get; } = new Food("pumpkin seeds", new(
        [(30, ServingUnits.Gram), (1, ServingUnits.Scoop)], Cals: 170, P: 9, F: 15, CTotal: 3, CFiber: 2));
    ...
    public static Food Farro_52_Gram { get; } = new Food("farro", new(
        [(0.25, ServingUnits.Cup), (52, ServingUnits.Gram)],
        Cals: 190,
    ...
    public static Food Gluten { get; } = new("gluten", new(
        [(0.25, ServingUnits.Cup), (30, ServingUnits.Gram)],
        Cals: 120,
    ...
    public static Food PearledBarley_45_Grams { get; } = new("pearled barley", new(
        [(0.25, ServingUnits.Cup), (45, ServingUnits.Gram)], Cals: 160, P: 4, F: 0.5, CTotal: 35, CFiber: 7),
    ...
    public static Food Seitan_Sprouts_Yeast_1_Gram_Gluten_4x { get; } = new(
        ...
        NutritionalYeast_Sprouts.NutritionalInformation.Combine(Gluten.NutritionalInformation, ServingUnits.Gram, 4),
