...
internal static class TrainingWeeks
{
    ...
    public static TrainingWeek MuscleGain3TrainingWeek => new(
        ...
        [
            new("Waking",
                ...
                new("Blueberry oatmeal shake",
                    [new(Foods.BlueBerries_1_Scoop, ServingUnits.Scoop, 3)],
                    Foods.PeaProtein_1_Scoop, ServingUnits.Scoop,
                    Foods.AlmondMilk_2_Cup, ServingUnits.Cup,
            ...
            new("Bedtime",
                ...
                new("Shake",
                    [new(Foods.AlmondMilk_2_Cup, ServingUnits.Cup, 1)],
                    Foods.PeaProtein_1_Scoop, ServingUnits.Scoop,
                    Foods.AlmondButter_1_Tbsp, ServingUnits.Tablespoon,
                    Foods.FatToCarbConversion, ServingUnits.Gram,
                    FoodGrouping.PreparationMethodEnum.PrepareAsNeeded)),
        ...
        [
            ...
            new("40 minutes after workout",
                new(P: PROTEIN_PER_MEAL_ON_WORKOUT_DAY, F: 10, C: 120),
                FoodGroupings.Rice_BlackBeans_PumpkinSeeds),
            new("2-4 hours after last meal",
                new(P: PROTEIN_PER_MEAL_ON_WORKOUT_DAY, F: 20, C: 100),
                FoodGroupings.Rice_BlackBeans_PumpkinSeeds),
            new("3-5 hours after last meal",
