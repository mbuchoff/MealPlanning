...
internal static class TrainingWeeks
{
    ...
    public static TrainingWeek MuscleGain3TrainingWeek { get; } = new(
        nonworkoutMeals:
        [
            new("Waking", new Macros(P: 40, F: 10, C: 60), FoodGroupings.Oatmeal),
            new("3-5 hours after last meal", new Macros(P: 40, F: 20, C: 60), FoodGroupings.Seitan),
            new("3-5 hours after last meal", new Macros(P: 40, F: 20, C: 60), FoodGroupings.Seitan),
            new("3-5 hours after last meal", new Macros(P: 40, F: 20, C: 60), FoodGroupings.FarroAndEdamame),
            new("Bedtime", new Macros(P: 40, F: 25, C: 0) - Foods.AlmondMilk_2_Cup.NutritionalInformation.Macros,
                new(Foods.PeaProtein_1_Scoop,
                    Foods.AlmondButter_1_Tbsp,
                    Foods.Oatmeal_Walmart_1_Scoop)),  // Will come up slightly negative, subtract from first meal
        ],
        ...
        [
            ...
            new("40 minutes after workout", new(P: 30, F: 10, C: 120), FoodGroupings.Seitan),
            new("2-4 hours after last meal", new(P: 30, F: 20, C: 100), FoodGroupings.Seitan),
            new("3-5 hours after last meal", new(P: 30, F: 20, C: 50), FoodGroupings.FarroAndEdamame),
            new("Bedtime", new(P: 30, F: 25, C: 35), FoodGroupings.Oatmeal),
        ],
        xfitMeals:
        [
            ...
            new("40 minutes after workout", new(P: 30, F: 10, C: 120), FoodGroupings.Seitan),
            new("2-4 hours after last meal", new(P: 30, F: 20, C: 100), FoodGroupings.Seitan),
            new("3-5 hours after last meal", new(P: 30, F: 20, C: 100), FoodGroupings.FarroAndEdamame),
            new("Bedtime", new(P: 30, F: 25, C: 65), FoodGroupings.Oatmeal),
        ]);
}
